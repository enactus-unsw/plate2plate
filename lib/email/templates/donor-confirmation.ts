...
<head>
  ...
  <title>Your listing is live on FoodCompass</title>
</head>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;margin:24px auto;background-color:#FFFFFF;border-radius:12px;border:1px solid #E5DDD0;">
          <tr>
            <td style="padding:40px;">
              ...
              <!-- Heading -->
              <h1 style="font-size:24px;color:#18160F;text-align:center;margin:16px 0 8px;font-weight:700;">Your listing is live!</h1>
              <p style="font-size:15px;color:#6B6254;text-align:center;line-height:1.6;margin:0 0 24px;">Students can now see and claim your food on campus.</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F4F0E8;border-radius:8px;margin:24px 0;">
                <tr>
                  <td style="padding:20px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:4px 0;font-size:14px;color:#6B6254;width:90px;vertical-align:top;">Food</td>
                        <td style="padding:4px 0;font-size:14px;color:#18160F;font-weight:600;">${listing.title}</td>
                      </tr>
                      <tr>
                        <td style="padding:4px 0;font-size:14px;color:#6B6254;width:90px;vertical-align:top;">Category</td>
                        <td style="padding:4px 0;font-size:14px;color:#18160F;">${listing.food_category}</td>
                      </tr>
                      <tr>
                        <td style="padding:4px 0;font-size:14px;color:#6B6254;width:90px;vertical-align:top;">Quantity</td>
                        <td style="padding:4px 0;font-size:14px;color:#18160F;">${listing.quantity} servings</td>
                      </tr>
                      <tr>
                        <td style="padding:4px 0;font-size:14px;color:#6B6254;width:90px;vertical-align:top;">Pickup</td>
                        <td style="padding:4px 0;font-size:14px;color:#18160F;">${listing.pickup_location}</td>
                      </tr>
                      <tr>
                        <td style="padding:4px 0;font-size:14px;color:#6B6254;width:90px;vertical-align:top;">Expires</td>
                        <td style="padding:4px 0;font-size:14px;color:#18160F;">${formatDateTime(listing.expires_at)}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <!-- Warning Box -->
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FBF0E0;border-radius:8px;border-left:4px solid #B87333;margin:24px 0;">
                <tr>
                  <td style="padding:16px;">
                    <div style="font-size:14px;font-weight:600;color:#18160F;margin-bottom:6px;">&#9888;&#65039; Save your management link</div>
                    <div style="font-size:13px;color:#6B6254;line-height:1.5;">This is the only way to edit or close your listing. We recommend saving it somewhere safe.</div>
                  </td>
                </tr>
              </table>
